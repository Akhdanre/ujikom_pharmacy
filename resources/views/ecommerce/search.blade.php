...
<head>
    ...
    <title>Hasil Pencarian - DrigSell</title>
...
<body>
            ...
            <div class="row align-items-center py-3">
                ...
                <div class="col-md-6">
                    <form class="d-flex" action="{{ route('search') }}" method="GET">
                        <input type="text" name="q" class="search-bar" placeholder="Cari obat, vitamin, atau suplemen..." value="{{ $query ?? '' }}">
    ...
    <div class="container py-4">
        ...
        <div class="search-header">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h4 class="mb-1">Hasil Pencarian untuk: <span class="search-query">"{{ $query ?? 'obat' }}"</span></h4>
                    <p class="results-count mb-0">Ditemukan {{ count($medicines ?? []) }} produk</p>
                </div>
                <div class="col-md-6 text-end">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="sort-options">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <span class="text-muted">Menampilkan {{ count($medicines ?? []) }} hasil</span>
                        </div>
                        <div class="col-md-6 text-end">
                    ...
                    <div class="col-lg-4 col-md-6 col-6">
                        <div class="product-card">
                            <div class="product-image">
                                <img src="https://via.placeholder.com/300x200/00BFA6/FFFFFF?text=Search+{{ $i }}" alt="Product {{ $i }}">
                                @if($i <= 3)
                ...
                <div class="no-results">
                    ...
                    <p class="no-results-text">Maaf, tidak ada produk yang sesuai dengan pencarian "{{ $query ?? 'obat' }}"</p>
    ...
    <script>
        ...
        // Highlight search query in product titles
